...
iCivChina :	Techs([iTanning, iMining, iAgriculture, iPottery]),
...
iCivTamils :	Techs([iMedicine], column=4, exceptions=[]),
iCivEthiopia :	Techs([iAlloys, iWriting, iCalendar, iPriesthood], column=2),
iCivKorea :		Techs([iSteel], column=5),
...
iCivTibet :		Techs([iNobility, iScholarship, iEthics, iTheology], column=5),
iCivIndonesia :	Techs([iArtisanry, iEthics], column=5, exceptions=[iGeneralship]),
...
iCivHolyRome :	Techs([iFeudalism, iMachinery, iTheology], column=6),
iCivRussia :	Techs([iFeudalism], column=6, exceptions=[iScholarship]),
iCivMali : 		Techs([iAlchemy, iTheology], column=6),
iCivPoland : 	Techs([iCommune, iCropRotation, iDoctrine], column=7, exceptions=[iAlchemy, iGuilds]),
iCivPortugal :	Techs([iCommune, iCropRotation, iPaper, iPatronage], column=7),
...
iCivItaly : 	Techs([iCommune, iCropRotation, iPaper, iCompass, iDoctrine], column=7),
...
#iCivRussia :	Techs([iCompanies, iJudiciary], column=8),
iCivCongo : 	Techs([iMachinery, iCivilService, iTheology], column=6),
iCivThailand : 	Techs(column=8, exceptions=[iCompass, iCommune]),
...
iCivChina :		Techs([iMachinery, iCivilService], column=6, exceptions=[iNobility]),
...
iCivPersia :	Techs([iAlchemy], column=6, exceptions=[iScholarship, iEthics]),
iCivTamils :	Techs([iGuilds], column=6, exceptions=[iNobility, iPolitics]),
iCivEthiopia :	Techs(column=5, exceptions=[iGeneralship, iPhilosophy]),
iCivMaya :		Techs([iCement, iMathematics, iContract, iLiterature, iPriesthood, iLaw], column=3),
iCivKorea :		Techs([iMachinery, iAlchemy], column=6, exceptions=[iScholarship]),
iCivByzantium :	Techs([iMachinery, iCivilService], column=6),
iCivJapan :		Techs(column=6, exceptions=[iScholarship]),
iCivVikings :	Techs([iGuilds], column=6),
iCivTurks :		Techs([iNobility, iSteel, iArtisanry], column=5, exceptions=[iNavigation, iMedicine, iPhilosophy]),
},
{
iCivIndependent:Techs(column=10),
iCivIndependent2:Techs(column=10),
iCivChina :		Techs([iCombinedArms, iUrbanPlanning, iHorticulture], column=10, exceptions=[iExploration, iOptics]),
...
iCivEthiopia :	Techs(column=10, exceptions=[iExploration]),
iCivKorea :		Techs([iUrbanPlanning, iHorticulture], column=10, exceptions=[iExploration, iOptics]),
...
iCivTurks :		Techs([iHorticulture], column=10, exceptions=[iExploration]),
iCivTibet :		Techs(column=10, exceptions=[iExploration]),
iCivIndonesia :	Techs([iHorticulture], column=10, exceptions=[iExploration]),
iCivMoors :		Techs([iCombinedArms, iUrbanPlanning, iHorticulture], column=10, exceptions=[iExploration]),
...
iCivHolyRome :	Techs(column=11, exceptions=[iExploration, iGeography, iEconomics]),
iCivRussia : 	Techs([iCombinedArms, iUrbanPlanning], column=10, exceptions=[iExploration]),
iCivPoland :	Techs([iCombinedArms, iScientificMethod, iCivilLiberties], column=10),
iCivPortugal :	Techs([iCombinedArms, iGeography, iHorticulture], column=10),
iCivItaly :		Techs(column=11, exceptions=[iUrbanPlanning, iHorticulture]),
...
iCivThailand :	Techs([iHorticulture], column=10, exceptions=[iExploration, iOptics]),
